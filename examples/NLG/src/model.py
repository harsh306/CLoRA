...
class GPT2Model(nn.Module):
    ...
    def forward(
        ...
        for block, layer_past in zip(self.h, past):
            ...
            if count == 18:
                hidden_states = self.lora_w_skip_mlp(skip_hidden_states_14) + hidden_states + self.lora_w_skip_mlp4(skip_hidden_states_2)
            if count == 20:
                skip_hidden_states_20 = hidden_states
            if count == 24:
                hidden_states = self.lora_w_skip_mlp3(skip_hidden_states_20) + hidden_states + self.lora_w_skip_mlp2(skip_hidden_states_2)
