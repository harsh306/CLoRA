...
class HomotopyLinear(nn.Module):
    def __init__(self, in_features, homotopy_param = 1e-7):
...
class SparseEncoder(nn.Module):
    def __init__(self, dim, rank):
        ...
        self.lora_encoder = SparseLinear(dim, rank, sparsity=0.4)
...
class SparseDecoder(nn.Module):
    def __init__(self, dim, rank):
        ...
        self.lora_decoder = SparseLinear(rank, dim, sparsity=0.4)
